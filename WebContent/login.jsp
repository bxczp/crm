									...
									<DIV style="TEXT-ALIGN: left; WIDTH: 265px; FLOAT: right; HEIGHT: 125px; _height: 95px">
										<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
											<TBODY>
												...
												<TR>
													<td><select id="roleName" name="roleName" class="input" style="margin-top: 15px; height: 24px">
											...
											<TBODY>
												...
												<TR>
													<TD width=100 align=right><INPUT
															...
															src="${pageContext.request.contextPath}/images/btn1.jpg" type=image name=btnLogin
